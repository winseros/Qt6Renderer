...
class QBitArraySynth:
    ...
    def __init__(self, valobj: SBValue):
        ...
        self._values_zero = [
            self._valobj.CreateValueFromData(QBitArraySynth._PROP_SIZE, size_data_zero, self._type_long_long)
        ]
    ...
    def get_child_index(self, name: str) -> int:
        if name == QBitArraySynth._PROP_SIZE:
            return 0
        else:
        ...
        if d_d_size_val:
            ...
            if error.Success():
                ...
                if d_bits_val:
                    ...
                    self._values = [
                        self._valobj.CreateValueFromData(QBitArraySynth._PROP_SIZE, size_data, self._type_long_long)
                    ]
